export type FieldVerificationStatus = "Pending" | "Approved" | "Rejected";
...
export interface Driver {
    ...
    fieldVerification: {
        email: FieldVerificationStatus;
        mobile: FieldVerificationStatus;
        nic: FieldVerificationStatus;
        nicPhotoFront: FieldVerificationStatus;
        nicPhotoBack: FieldVerificationStatus;
        license: FieldVerificationStatus;
        licensePhotoFront: FieldVerificationStatus;
        licensePhotoBack: FieldVerificationStatus;
        vehicleType: FieldVerificationStatus;
        vehicleColor: FieldVerificationStatus;
        vehicleRegNo: FieldVerificationStatus;
        vehicleName: FieldVerificationStatus;
        vehicleSeats: FieldVerificationStatus;
        vehiclePhotoFront: FieldVerificationStatus;
        vehiclePhotoBack: FieldVerificationStatus;
    };
}
